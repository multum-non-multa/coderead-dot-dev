...
Were it not for the `list` data structure, you might have to create a variable for every score, an impossibility when dealing with a program that is supposed run without your having to intervene or anticipate every possible score sets. What if you have over a hundred scores for every player --- every time he gets credit for the slightest event?
